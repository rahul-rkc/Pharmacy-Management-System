...
<div id="main_container">
  <div class="header">
    <div id="logo">
        <a href="#">
            <!--<img src="images/logo.png" alt="" width="162" height="54" border="0" /></a>-->
    </div>
...
<!--    <div class="box_content">
      <div class="box_title">
        <div class="title_icon">
            <img src="images/mini_icon2.gif" alt="" /></div>
        <h2><span class="dark_blue">Vendor</span>      </h2>
      </div>
      <div class="box_text_content">  <img src="images/checked.gif" alt="" class="box_icon" />
        <div class="box_text"><a href="viewCurrentVendors.jsp" style="color:teal;">View vendors</a></div>
      </div>
    </div>-->
    <div class="box_content">
      <div class="box_title">
