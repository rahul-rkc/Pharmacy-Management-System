...
public class VendorSignup extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String repass = request.getParameter("vrpass");
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        if (vid.equals(retid)) {
                            ...
                            out.write("vendor already exists");
                        }
                    }
                    if (flag == 0) {
//                    	out.write("here2");
                        String usr_id=request.getParameter(vid);
		String passs=request.getParameter(pass);
                out.write(usr_id+"  "+passs+" in try block");
                    	int vnd_stat=0;
                        ...
                        out.write("Succesfully account created."+i);
